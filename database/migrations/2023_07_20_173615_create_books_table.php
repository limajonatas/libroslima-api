...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('books', function (Blueprint $table) {
            ...
            $table->double('accumulated_read_time', 10, 2)->nullable()->default(0);
            $table->double('time_read_total', 10, 2)->nullable()->default(0);
            $table->double('time_read_per_page', 10, 2)->nullable()->default(0);
